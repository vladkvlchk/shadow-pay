...
export interface MockWallet {
  ...
  export function getOrCreateMockWallet(): MockWallet {
    const stored = localStorage.getItem("ghostpay_mock_wallet")
    ...
    localStorage.setItem("ghostpay_mock_wallet", JSON.stringify(wallet))
    return wallet
  }
  ...
  export function getMockTransactions(): MockTransaction[] {
    const stored = localStorage.getItem("ghostpay_mock_transactions")
  ...
  export function saveMockTransaction(transaction: MockTransaction): void {
    ...
    localStorage.setItem("ghostpay_mock_transactions", JSON.stringify(transactions))
  }
